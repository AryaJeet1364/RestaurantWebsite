...
const Header = () => {
  ...
  return (
    <motion.header
      className="fixed w-full max-w-[1800px] z-50 py-1"
      ...
      >
        <div className="flex justify-between items-center px-4 lg:px-0 relative text-white">
          ...
          <motion.div
            ...
            className="order-1 lg:order-none ml-[5vw]"
          >
            <a href="#">
              <img
                className={`${
          ...
          <motion.div
            ...
            initial="hidden"
            animate={nav ? "show" : ""}
            className="bg-accent absolute w-[310px] h-[50vh] right-0 lg:left-0 top-[120px] bottom-0 z-50 rounded-lg shadow-xl"
          >
            <Nav />
          </motion.div>
        </div>
